    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/law25/[business_name]">Law25 - /law25/[business_name]</Link></li>
<li><Link href="/dashboard">Dashboard - /dashboard</Link></li>
<li><Link href="/login">Login - /login</Link></li>
<li><Link href="/newpage/[business_name]">NewPage - /newpage/[business_name]</Link></li>
<li><Link href="/training">Training - /training</Link></li>
<li><Link href="/pharmacy">Pharmacy - /pharmacy</Link></li>
<li><Link href="/examplepage">Examplepage - /examplepage</Link></li>
          </ul>
